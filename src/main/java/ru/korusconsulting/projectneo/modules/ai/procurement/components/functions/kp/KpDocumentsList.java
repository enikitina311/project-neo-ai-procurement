...
@Extension
public class KpDocumentsList extends DataFunctionBase implements DataFunction {
    @Override
    public String name() {
        return "korus_ai_procurement__kp_documents_list";
    }

    @Override
    public String description() {
        return "List KP documents by package_id";
    }
    ...
    public Object execute(ComponentArgs args) {
        ...
        return AppContext.tryGet(ProcurementKpDocumentService.class)
