...
@Extension
public class SupplierList extends DataFunctionBase implements DataFunction {
    @Override
    public String name() {
        return "korus_ai_procurement__supplier_list";
    }

    @Override
    public String description() {
        return "List suppliers by package_id";
    }
